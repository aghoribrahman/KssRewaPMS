-- ==========================================
-- ADD CLINICAL METRICS: WEIGHT & BP
-- ==========================================

-- 1. Add columns to patient_visits
ALTER TABLE public.patient_visits 
ADD COLUMN IF NOT EXISTS weight NUMERIC CHECK (weight > 0 AND weight < 500),
ADD COLUMN IF NOT EXISTS bp TEXT;

-- 2. Update RPC to handle these new fields
