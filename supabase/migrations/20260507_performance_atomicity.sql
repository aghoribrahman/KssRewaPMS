-- ==========================================
-- ADVANCED PERFORMANCE & ATOMICITY MIGRATION
-- ==========================================

-- 1. Database Performance (Indexes)
-- Fast joins between visits and master
CREATE INDEX IF NOT EXISTS idx_patient_visits_patient_id ON public.patient_visits(patient_id);

-- Fast queue filtering by status
...
-- Fast lookup for returning patients by contact or unique IDs
CREATE INDEX IF NOT EXISTS idx_patient_master_lookup ON public.patient_master(contact, abha_id, aadhar_number);

-- 2. Transaction Safety (Postgres RPC)
-- Atomic function to register a patient and their first visit
